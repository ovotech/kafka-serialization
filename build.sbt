...
lazy val avro4sVersion = "2.0.2"
lazy val json4sVersion = "3.6.1"
lazy val jerseyVersion = "2.27"
...
lazy val avro = project
  ...
  .settings(
    ...
    libraryDependencies ++= Seq(
      "io.confluent" % "kafka-avro-serializer" % "4.1.2" exclude ("org.slf4j", "slf4j-log4j12"),
...
lazy val core = project
  ...
  .settings(
    ...
    libraryDependencies ++= Seq(
      "org.apache.kafka" % "kafka-clients" % "1.1.1" exclude ("org.slf4j", "slf4j-log4j12"),
